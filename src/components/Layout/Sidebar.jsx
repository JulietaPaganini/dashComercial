...
import { LayoutDashboard, Users, UploadCloud, PieChart, Mail, LogOut } from 'lucide-react';
    ...
    return (
        <aside className="fixed left-0 top-0 h-full w-64 bg-white border-r border-gray-200 flex flex-col p-6 z-10">
            ...
            <div className="border-t border-gray-100 pt-4 mt-2">
                <button
                    onClick={logout}
                    className="w-full text-left flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-red-600 hover:bg-red-50 transition-all duration-200"
                >
